...
BOOST_AUTO_TEST_CASE(test_subscript)
{
    ...
    BOOST_REQUIRE_EQUAL(m(1, 0), 4.0);
    BOOST_REQUIRE_EQUAL(m(1, 1), 5.0);
    BOOST_REQUIRE_EQUAL(m(1, 2), 6.0);
    BOOST_REQUIRE_EQUAL(m(2, 0), 7.0);
    BOOST_REQUIRE_EQUAL(m(2, 1), 8.0);
    BOOST_REQUIRE_EQUAL(m(2, 2), 9.0);
...
BOOST_AUTO_TEST_CASE(test_add)
{
	...
	BOOST_REQUIRE_EQUAL(m3(0, 0), 2.0);
    BOOST_REQUIRE_EQUAL(m3(0, 1), 2.0);
    BOOST_REQUIRE_EQUAL(m3(0, 2), 3.0);
    BOOST_REQUIRE_EQUAL(m3(1, 0), 4.0);
    BOOST_REQUIRE_EQUAL(m3(1, 1), 6.0);
    BOOST_REQUIRE_EQUAL(m3(1, 2), 6.0);
    BOOST_REQUIRE_EQUAL(m3(2, 0), 7.0);
    BOOST_REQUIRE_EQUAL(m3(2, 1), 8.0);
    BOOST_REQUIRE_EQUAL(m3(2, 2), 10.0);
}
...
BOOST_AUTO_TEST_CASE(test_subtract)
{
	...
	BOOST_REQUIRE_EQUAL(m3(0, 0), 0.0);
    BOOST_REQUIRE_EQUAL(m3(0, 1), 2.0);
    BOOST_REQUIRE_EQUAL(m3(0, 2), 3.0);
    BOOST_REQUIRE_EQUAL(m3(1, 0), 4.0);
    BOOST_REQUIRE_EQUAL(m3(1, 1), 4.0);
    BOOST_REQUIRE_EQUAL(m3(1, 2), 6.0);
    BOOST_REQUIRE_EQUAL(m3(2, 0), 7.0);
    BOOST_REQUIRE_EQUAL(m3(2, 1), 8.0);
    BOOST_REQUIRE_EQUAL(m3(2, 2), 8.0);
}
...
BOOST_AUTO_TEST_CASE(test_multiply_scalar1)
{
	...
	BOOST_REQUIRE_EQUAL(m2(0, 0), 3.0);
    BOOST_REQUIRE_EQUAL(m2(0, 1), 6.0);
    BOOST_REQUIRE_EQUAL(m2(0, 2), 9.0);
    BOOST_REQUIRE_EQUAL(m2(1, 0), 12.0);
    BOOST_REQUIRE_EQUAL(m2(1, 1), 15.0);
    BOOST_REQUIRE_EQUAL(m2(1, 2), 18.0);
    BOOST_REQUIRE_EQUAL(m2(2, 0), 21.0);
    BOOST_REQUIRE_EQUAL(m2(2, 1), 24.0);
    BOOST_REQUIRE_EQUAL(m2(2, 2), 27.0);
}
