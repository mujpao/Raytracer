...
BOOST_AUTO_TEST_CASE(test_normalize)
{
	...
	BOOST_REQUIRE_EQUAL(Vec::normalize(v2), Vec(1.0 / std::sqrt(3.0), -1.0 / std::sqrt(3.0), 1.0 / std::sqrt(3.0), 0.0));
}
