...
int main() {
    ...
    Camera camera(Vec(0.1, 15.0, 6.0), Vec(0.0, 0.0, 0.0), Vec(0.0, 1.0, 0.0),
        45.0, aspect);
    ...
    // int width = 400;
    // double aspect = 16.0 / 9.0;
    // // Camera camera(Vec(0.1, 3.0, 0.0), Vec(0.0, 0.0, 0.0), Vec(0.0, 1.0,
    // 0.0),
    // //     45.0, aspect);

    // Camera camera(Vec(0.0, 0.2, 0.96), Vec(0.0, 0.0, 0.0), Vec(0.0, 0.0,
    // -1.0),
    //     45.0, aspect);
    ...
    // Vec p4(-1.0, 0.0, 1.0);
    // auto tx
    //     = Transform::translate(0.4, 6.0, 1.0) *
